 ...
 * @author BAKILY AMINE
 */
@WebServlet(urlPatterns = {"/loginmodifServlet"})
public class loginmodifServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
             ...
             String req = "select * from users where login='"+login+"' and QS='"+QS+"' and RS='"+RS+"' ";
             ...
             {
                 response.sendRedirect("MDPOUBLIE_1.jsp");
